            ...
            if ($auto > 0) { ?>
                ...
                <div class="panel panel-default spacer col-md-6 col-xs-6 col-md-offset-3">
                    <div class="panel-heading">
                        <h2><u>Autorisation de sortie</u></h2>
                        <form method="post" action="acceuil.php">
                            <button type="submit" class="btn btn-success " value="ACCUEIL"> Accueil</button>
                        </form>
                    </div>
                    <div class="panel-body">
                        <td><strong class="couleur_texte">Format de date (mm/jj/aaaa). Exemple: 01/24/2017</strong></td>
                        </p>
                        <form action='enregautorisation.php' method='post'>
                            <div class="form-group">
                                <label class="control-label">Date:</label>
                                <input type="text" name="date" class="form-control datepicker-input" value="date du jour" required>
                            </div>
                            <div class="form-group">
                                <label class="control-label">Matricule</label>
                                <input type="texte" name="smat" value="<?php echo ($auto['smat'])  ?>" class="form-control " required>
                            </div>
                            <div class="form-group">
                                <label class="control-label">Nom</label>
                                <input type="texte" name="snom" value="<?php echo ($auto['snom'])  ?>" class="form-control " required>
                            </div>
                            <div class="form-group">
                                <label class="control-label">Prénom</label>
                                <input type="texte" name="sprenom" value="<?php echo ($auto['sprenom'])  ?>" class="form-control " required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="texte" name="sfonction" value="<?php echo ($auto['sfonction'])  ?>" class="form-control " required>
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Destination:</label>
                                    <input type="text" name="destination" class="form-control couleur_texte" placeholder="Votre destination" required>
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Motif:</label>
                                    <textarea type="text" name="objet" class="form-control couleur_texte" required placeholder="Votre motif"></textarea>
                                </div>
