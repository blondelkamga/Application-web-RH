...
<head>
    ...
    <h1>LISTE DES AUTORISATIONS DE SORTIES VALIDEES</h1>
</head>
            ...
            <table id="datatables-1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    while ($auto = mysql_fetch_array($resultat)) {
                        ?>
                        <tr>
                            <td><?php echo ($auto['datea']) ?></td>
                            <td><?php echo ($auto['mat']) ?></td>
                            <td><?php echo ($auto['nom']) ?></td>
                            <td><?php echo ($auto['prenom']) ?></td>
                            <td> <?php echo ($auto['service']) ?></td>
                            <td> <?php echo ($auto['fonction']) ?></td>
                            <td> <?php echo ($auto['destination']) ?></td>
                            <td><?php echo ($auto['objet']) ?></td>
                            <td style="color:blue;"><?php echo ($auto['val1']) ?></td>
                        </tr>
                    <?php
