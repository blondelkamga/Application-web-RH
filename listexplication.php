...
<head>
    ...
    <h1>LISTE DES DEMANDES D'EXPLICATIONS</h1>
</head>
            ...
            <table id="datatables-1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        ...
                        <th>FONCTION</th>
                        <th>MOTIF</th>
                        <th>DELAI DE REPONCE</th>
                        <th>COMMENTAIRE SERVICE EMETTEUR</th>
                        <th>SANCTION</th>
                        <th>NOMBRE DE JOUR(S) DE MISE A PIED</th>
                ...
                <tbody>
                    ...
                    while ($auto = mysql_fetch_array($resultat)) {
                        ...
                        <tr>
                            ...
                            <td><?php echo ($auto['delai']) ?></td>
                            <td> <?php echo ($auto['cmse']) ?></td>
                            <td> <?php echo ($auto['sanction']) ?></td>
                            <td> <?php echo ($auto['nbrejmap']) ?></td>
                            <td> <?php echo ($auto['dateemett']) ?></td>
                            <td> <?php echo ($auto['obs']) ?></td>
                            <td> <?php echo ($auto['datedir']) ?></td>
                            <td>
                                <a href="../rh/scanner/<?php echo ($auto['img_nom']) ?>" 
                               
                                ><?php echo ($auto['img_nom']) ?></a>
                            </td>
                            <?php
                            if (empty($auto['img_nom'])){
                                ?>
                            <td><a class=" btn btn-success" href="scanner.php?ide=<?php echo ($auto['ide']); ?>" role="button">Joindre un fichier</a></td>
                        </tr>
                            <?php }
