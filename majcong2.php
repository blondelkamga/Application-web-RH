...
<head>
	...
	<h1>DEMANDES DE CONGE EN ATTENTE RH</h1>
</head>
...
<body align="center">
	...
	if (isset($_POST["valider"])) {
		$req = "UPDATE conge SET decrhc='" . $_POST['decrhc'] . "',nbrjr3c='" . $_POST['nbrjr3c'] . "',motfirefdirc='" . $_POST['motfirefdirc'] . "',decdirc='" . $_POST['decdirc'] . "',nbrjr4c='" . $_POST['nbrjr4c'] . "' WHERE idc='" . $_POST['numorg'] . "'";
			...
			<table id="datatables-1" class="table table-striped table-bordered" cellspacing="0" width="100%">
				...
				<tbody>
					...
					while ($auto = mysql_fetch_array($resultat)) {
						?>
						<tr>
							<td><?php echo ($auto['matc']) ?></td>
							<td><?php echo ($auto['nomc']) ?></td>
							<td><?php echo ($auto['prenomc']) ?></td>
							<td><?php echo ($auto['servicec']) ?></td>
							<td> <?php echo ($auto['fonctionc']) ?></td>
							<td> <?php echo ($auto['datepjc']) ?></td>
							<td><?php echo ($auto['datedjc']) ?></td>
							<td> <?php echo ($auto['nbrejc']) ?></td>
							<td> <?php echo ($auto['datert']) ?></td>
							<td> <?php echo ($auto['typec']) ?></td>
							<td> <?php echo ($auto['nbrjrc1']) ?></td>
							<td> <?php echo ($auto['remplc']) ?></td>
							<td><a class="btn btn-success" href="majcong3.php?id=<?php echo ($auto['idc']) ?>" role="button"> Validé</a></td>
						</tr>
					<?php
