...
<head>
    ...
    <h1>LISTE DES CONGES VALIDEES</h1>
</head>
                ...
                <tbody>
                    ...
                    while ($auto = mysql_fetch_array($resultat)) {
                        ...
                        <tr>
                            ...
                            <td> <?php echo ($auto['nbrjr3c']) ?></td>
                            <td> <?php echo ($auto['remplc']) ?></td>
                            <td> <?php echo ($auto['decdirc']) ?></td>
                            <td style="color:blue;"> <?php echo ('Validé') ?></td>
                        </tr>
                    <?php
