        ...
        <thead> 
		 ...
		 <?php 	
			...
			$resultat = mysql_query( $sql, $cnx ) ;
				if($resultat){
			 echo "<h1>LISTE EMPLOYES ABSENT (DIRECTION)</h1>\n";
				 ...
				 $resultat2 = mysql_query( $sql2, $cnx ) ;
				 	...
				 	while( $auto2 = mysql_fetch_array($resultat2)) {
						...
						<tr>
							...
							<td> <?php echo($auto['obsCoordo']) ?></td>
							<td><a class="btn btn-success"
								   href="enregistrerCommDirect.php?id=<?php echo($auto['idAbscence']) ?>&nom=<?php echo($auto1['snom'] . ' ' . $auto1['sprenom'].'_'.$auto1['smat']) ?>"
