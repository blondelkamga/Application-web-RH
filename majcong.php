...
<html>
  <head>
	...
	<h1>DEMANDES DE CONGE EN ATTENTE (CHEF SERVICE/CHEF AGENCE)</h1>
  </head>
...
<body align="center">
  <?php
	...
	if(isset($_POST["valider"])){
		$req="UPDATE conge SET decrescc='".$_POST['decrescc']."',nbrjrc1='".$_POST['nbrjrc1']."',motifrefc='".$_POST['motifrefc']."',remplc='".$_POST['remplc']."' WHERE idc='".$_POST['numorg']."'";
 ...
 if($resultat){
	 ...
	 <table id="datatables-1" class="table table-striped table-bordered" cellspacing="0" width="100%">
		...
		while( $auto = mysql_fetch_array($resultat))
		{
			...
			<td><a class="btn btn-success" href="majcong1.php?id=<?php echo($auto['idc'])?>" role="button"> Valider</a></td>
			</tr>
