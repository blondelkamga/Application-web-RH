...
<html>
  <head>
	...
	<h1>LISTE EMPLOYES DE VOTRE AGENCE</h1>
  </head>
<body>
	<div class="content">
								<!-- Page Heading Start -->
  	...
  	if(strcmp($_SESSION['login'],'Admin') == 0) {
		...
		<div class="col-md-12 col-xs-12">
			<table id="datatables-1" class="table table-striped table-bordered" cellspacing="0" width="100%">
				...
				if($resultat){
					echo "<h1>LISTE EMPLOYES DE VOTRE AGENCE</h1>\n";
					...
					while( $auto = mysql_fetch_array($resultat)){
						?>
						<tr>
							<td><?php echo ($auto['smat'])?></td>
							<td><?php echo ($auto['snom'])?></td>
							<td><?php echo ($auto['sprenom'])?></td>
							<td> <?php echo ($auto['sfonction'])?></td>
							<td> <?php echo ($auto['ssite'])?></td>
							<td><a class="btn btn-success" href="enregistrerAbscence.php?id=<?php echo($auto['smat'])?>&nom=<?php echo($auto['snom'])?>&prenom=<?php echo ($auto['sprenom'])?>&fonction=<?php echo ($auto['sfonction'])?>&site=<?php echo ($auto['ssite'])?>" role="button"> valider</a></td>
						</tr>
						<?php
					}
				}
	 ...
	 <table id="datatables-1" class="table table-striped table-bordered" cellspacing="0" width="100%">
        <thead> 
		 ...
		 <?php 	
			//affichage des données:
			//requête SQL:
			$sql = "SELECT * FROM `source` WHERE ssite = '".$_SESSION['site']."'";
			//exécution de la requête:
			$resultat = mysql_query( $sql, $cnx ) ;
				if($resultat){
			 echo "<h1>LISTE EMPLOYES DE VOTRE AGENCE</h1>\n";
		 ...
		 while( $auto = mysql_fetch_array($resultat)){ 
			...
			<td> <?php echo ($auto['ssite'])?></td>
			<td> <?php echo ($auto['sfonction'])?></td>
			<<td><a class="btn btn-success" href="enregistrerAbscence.php?id=<?php echo($auto['smat'])?>&nom=<?php echo($auto['snom'])?>&prenom=<?php echo ($auto['sprenom'])?>&site=<?php echo ($auto['ssite'])?>&fonction=<?php echo ($auto['sfonction'])?>" role="button"> valider</a></td>
			</tr>
			<?php
		}
	}
